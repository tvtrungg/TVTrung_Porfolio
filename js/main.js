...
var currentMonth = currentDate.getMonth(); // Lấy tháng hiện tại
...
// Close Map khi click vào nút close hoặc bất kì đâu ngoài map
$('.close_iframe, .class_blur').click(function () {
